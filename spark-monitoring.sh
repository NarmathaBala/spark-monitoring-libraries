...
export LOG_ANALYTICS_WORKSPACE_ID=1dca4332-c5ea-4bf2-8dd2-427fffba0e07
export LOG_ANALYTICS_WORKSPACE_KEY=0wDuH/ARoCxZGm8zdt6Isqi8D56W2KrkYcZFDZ3fWWHzhY1CC+rBEI6uyXlKtnGirieI056Z13UXoBMBjbrfCA==
export AZ_SUBSCRIPTION_ID=ec18dca1-0751-4307-bbac-6150896ac498
export AZ_RSRC_GRP_NAME=nh-common-rg-2673
export AZ_RSRC_PROV_NAMESPACE=Microsoft.Databricks
export AZ_RSRC_TYPE=workspaces
export AZ_RSRC_NAME=adb-test
